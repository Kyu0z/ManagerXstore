...
namespace QLBH.Class
{
    class Function
    {
        ...
        public static void Connect()
        {
            ...
            //Con.ConnectionString = "Data Source=DESKTOP-7VDO8JQ\\SQLEXPRESS;Initial Catalog=D:\\WINFORM\\QLBH\\QLBH\\QUANLYBANHANG.MDF;Integrated Security=True";
            //Con.ConnectionString = "Data Source=DESKTOP-7VDO8JQ\\SQLEXPRESS;Initial Catalog=D:\\WINFORM\\QLBH\\QLBH\\QUANLYBANHANG.MDF;Integrated Security=True";
            Con.ConnectionString = "Server=LAPTOP-KD\\SQLEXPRESS;Database=QLBHWF;Trusted_Connection=True;TrustServerCertificate=True";
        ...
        public static string GetFieldValues(string sql)  //trả về đường dẫn của ảnh thông qua câu lệnh sqli truy vấn
        {
            string ma = "";
