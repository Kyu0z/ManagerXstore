...
namespace QLBH
{
    public partial class HoaDonBanHang : Form
    {
        ...
        private void HoaDonBanHang_Load(object sender, EventArgs e)
        {
            ...
            txtGiamGia.Text = "0";
            txtTongTien.Text = "0";
            Function.FillCombo("SELECT MaKhach, TenKhach FROM tblKhach", cboMaKhach, "MaKhach", "TenKhach");
            cboMaKhach.SelectedIndex = -1;
            Function.FillCombo("SELECT MaNhanVien, TenNhanVien FROM tblNhanVien", cboMaNhanVien, "MaNhanVien", "TenNhanVien");
            cboMaNhanVien.SelectedIndex = -1;
            Function.FillCombo("SELECT MaHang, TenHang FROM tblHang", cboMaHang, "MaHang", "TenHang");
        ...
        {
            string str;
            str = "SELECT NgayBan FROM tblHoaDon WHERE MaHD = N'" + txtMaHDBan.Text + "'";
            dtpNgayBan.Value = DateTime.Parse(Function.GetFieldValues(str));
            str = "SELECT MaNhanVien FROM tblHoaDon WHERE MaHD = N'" + txtMaHDBan.Text + "'";
            cboMaNhanVien.Text = Function.GetFieldValues(str); // muốn thay đổi lại ten thì SelectedValue vào
            str = "SELECT MaKhach FROM tblHoaDon WHERE MaHD = N'" + txtMaHDBan.Text + "'";
            cboMaKhach.Text = Function.GetFieldValues(str);
            str = "SELECT TongDiem FROM tblHoaDon WHERE MaHD = N'" + txtMaHDBan.Text + "'";
            txtTongTien.Text = Function.GetFieldValues(str);
            lblTongTien.Text = "Bằng chữ: " + Function.ChuyenSoSangChuoi(double.Parse(txtTongTien.Text));
        }

        private void LoadDataGridView()
        {
            string sql;
            sql = "SELECT a.MaHang, b.TenHang, a.SoLuong, b.DonGiaBan, a.GiamGia,a.ThanhTien FROM tblChitiethoadon AS a, tblHang AS b WHERE a.MaHD = N'" + txtMaHDBan.Text + "' AND a.MaHang=b.MaHang";
            tblCTHDB = Function.GetDaTaToDaTaTable(sql);
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (!Function.CheckKey(sql))
            {
                ...
                sql = "INSERT INTO tblHoaDon(MaHD, NgayBan, MaNhanVien, MaKhach,TongDiem) VALUES (N'" + txtMaHDBan.Text.Trim() + "','" +
            ...
            sql = "SELECT MaHang FROM tblChitiethoadon WHERE MaHang=N'" + cboMaHang.SelectedValue + "' AND MaHD = N'" + txtMaHDBan.Text.Trim() + "'";
            if (Function.CheckKey(sql))
            {
            ...
            sql = "INSERT INTO tblChitiethoadon(MaHD,MaHang,SoLuong,DonGia, GiamGia,ThanhTien) VALUES(N'" + txtMaHDBan.Text.Trim() + "',N'" + cboMaHang.SelectedValue + "'," + txtSoLuong.Text + "," + txtDonGia.Text + "," + txtGiamGia.Text + "," + txtThanhTien.Text + ")";
            Function.RunSQL(sql);
            LoadDataGridView();
            ...
            tong = Convert.ToDouble(Function.GetFieldValues("SELECT TongDiem FROM tblHoaDon WHERE MaHD = N'" + txtMaHDBan.Text + "'"));
            Tongmoi = tong + Convert.ToDouble(txtThanhTien.Text);
            sql = "UPDATE tblHoaDon SET TongDiem =" + Tongmoi + " WHERE MaHD = N'" + txtMaHDBan.Text + "'";
            Function.RunSQL(sql);
            txtTongTien.Text = Tongmoi.ToString();
            lblTongTien.Text = "Bằng chữ: " + Function.ChuyenSoSangChuoi(double.Parse(Tongmoi.ToString()));
            ResetValuesHang();
            btnXoaHoaDon.Enabled = true;
            btnThem.Enabled = true;
            btnInHoaDon.Enabled = true;
        ...
        {
            Function.FillCombo("SELECT MaHD FROM tblHoaDon", cboMaHoaDon, "MaHD", "MaHD");
        ...
        private void btnXoaHoaDon_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = "SELECT MaHang,SoLuong FROM tblChitiethoadon WHERE MaHD = N'" + txtMaHDBan.Text + "'";
                DataTable tblHang = Function.GetDaTaToDaTaTable(sql);
                ...
                sql = "DELETE tblChitiethoadon WHERE MaHD=N'" + txtMaHDBan.Text + "'";
                Function.RunSQL(sql);
        ...
        private void btnInHoaDon_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:B1"].Value = "Shop KTV.";
            exRange.Range["A2:B2"].MergeCells = true;
            exRange.Range["A2:B2"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A2:B2"].Value = "Bình Dương";
            ...
            sql = "SELECT a.MaHD, a.NgayBan, a.TongDiem, b.TenKhach, b.DiaChi, b.DienThoai, c.TenNhanVien FROM tblHoaDon AS a, tblKhach AS b, tblNhanVien AS c WHERE a.MaHD = N'" + txtMaHDBan.Text + "' AND a.MaKhach = b.MaKhach AND a.MaNhanVien = c.MaNhanVien";
            tblThongtinHD = Function.GetDaTaToDaTaTable(sql);
            ...
            sql = "SELECT b.TenHang, a.SoLuong, b.DonGiaBan, a.GiamGia, a.ThanhTien " +
                  "FROM tblChitiethoadon AS a , tblHang AS b WHERE a.MaHD = N'" +
                  txtMaHDBan.Text + "' AND a.MaHang = b.MaHang";
            tblThongtinHang = Function.GetDaTaToDaTaTable(sql);
        ...
        private void dgvHDBanHang_DoubleClick(object sender, EventArgs e)
        {
            ...
            if ((MessageBox.Show("Bạn có chắc chắn muốn xóa không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes))
            {
                ...
                sql = "DELETE tblChitiethoadon WHERE MaHD=N'" + txtMaHDBan.Text + "' AND MaHang = N'" + MaHangxoa + "'";
                Function.RunSQL(sql);
                // Cập nhật lại số lượng cho các mặt hàng
